...
import com.bsuir.iamchrisep.facefilters.camera.CameraSourcePreview;
...
public class MainActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        final Button button = findViewById(R.id.flipButton);
        button.setOnClickListener(mFlipButtonListener);

        mToggleButton = (ToggleButton)findViewById(R.id.toggleButton);
        Log.d("TOGGLEVAR1", String.valueOf(mToggleButton.isChecked()));
        mToggleButton.setOnClickListener(mToggleButtonListener);
    ...
    private View.OnClickListener mToggleButtonListener = new View.OnClickListener() {
        public void onClick(View v) {
            if(((ToggleButton) v).isChecked()) {
                Log.d("TOGGLEHECK", "ON");
            } else {
                Log.d("TOGGLEHECK", "OFF");
            }

            Log.d("TOGGLEVAR2", String.valueOf(mToggleButton.isChecked()));
...
//                .setMode(FaceDetector.FAST_MODE)
                ...
                .setMinFaceSize(mIsFrontFacing ? 0.35f : 0.10f)
                .build();
        ...
        if (mIsFrontFacing) {
            ...
            // face position.
            Tracker<Face> tracker = new GraphicFaceTracker(mGraphicOverlay, context, mIsFrontFacing);
            ...
            MultiProcessor.Factory<Face> factory = new MultiProcessor.Factory<Face>() {
                ...
                public Tracker<Face> create(Face face) {
                    return new GraphicFaceTracker(mGraphicOverlay, context, mIsFrontFacing);
                }
            };
