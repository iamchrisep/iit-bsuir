...
//        timer.removeCallbacks(timerTask);
        if (editTitle.getText().toString().isEmpty()) {
            this.editTitle.setText(mItem.getCreated().toString("yyyy-MM-dd HH:mm:ss"));
        }
        saveData();
    }
    ...
    private void saveData() {
        ...
        if (mItem.getChecked().booleanValue() != editCheckBox.isChecked()) {
            mItem.setChecked(editCheckBox.isChecked());
            mItem.setUpdated(DateTime.now(DateTimeZone.getDefault()));
            isUpdated = true;
        }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        editCheckBox = (CheckBox) rootView.findViewById(R.id.checkBox);

        editTitle.setText(mItem.getTitle());
        editContent.setText(mItem.getContent());
        editCheckBox.setChecked(mItem.getChecked());
