...
<table width="1345" border="0" bgcolor="#a8ddff" class="globaltable" cellspacing="0" cellpadding="0">
  ...
  <td width="80%" bgcolor="{MAIN_COLOR}">
   <!-- inner table for main only -->
    <table border="0" width="100%" cellspacing="5" cellpaddong="5">
     ...
     <tr>
      <td width="65%">
		<iframe width="100%" height="800px" src="text.txt" style="overflow:hidden"></iframe>
		
      </td>
      <td width="35%">
       <h4 style="margin-top:10px"> <a href="rss.php"><img src="images/rss.png" style="width:15px"></img></a> Новости</h4>
       <ul class="newsmenu">
        {NEWS}
       </ul>
      </td>
